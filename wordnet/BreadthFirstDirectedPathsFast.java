 ...
 * @author Kevin Wayne
 */
public class BreadthFirstDirectedPathsFast {
     ...
     */
    public BreadthFirstDirectedPathsFast(Digraph G, int s) {
     ...
     */
    public BreadthFirstDirectedPathsFast(Digraph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
        for (int v = 0; v < G.V(); v++)
    ...
    public static void main(String[] args) {
        ...
        BreadthFirstDirectedPathsFast bfs = new BreadthFirstDirectedPathsFast(G, s);
